    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span>MultiCriterian Desicion</span>
        </a>
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Metodos:</h6>
            <a class="collapse-item" href="multicriteria_scoring_model.php">SMS</a>
            <a class="collapse-item" href="analytic_hierarchy_process.php">AHP</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Multicriteria Scoring Model</h1>
          </div>
              ...
              <div class="col-md-9 offset-md-1">
                ...
                <div class="card mb-4">
                  <div class="card-header">
                    Multi Criterian table Generator
                  </div>
                  <div class="card-body">
                    <form action="controllers/maximaxcontroller.php" method="POST" id="form_matrix_generator">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4" style="margin-top: 10px">
                          <label for="alternatives">Cantidad de Alternativas:</label>
                        </div>
                        <div class="col-md-8">
                          <input type="number" min="1" max="15" placeholder="Ingrese un número" class="form-control" name="alternatives" id="alternatives" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row" style="margin-top: 30px">
                        <div class="col-md-4">
                          <label for="criterians">Cantidad de Criterios:</label>
                        </div>
                        <div class="col-md-8">
                          <input type="number" min="1" max="15" placeholder="Ingrese un número" class="form-control" name="criterians" id="criterians" required>
                        </div>
                      </div>
                      <div class="form-group row" style="margin-top: 30px">
        ...
        <script src="js/multicriteriaSM.js"></script>
